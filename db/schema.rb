...
ActiveRecord::Schema.define(version: 2023_09_23_045023) do
  ...
  create_table "book_marks", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_book_marks_on_email", unique: true
    t.index ["reset_password_token"], name: "index_book_marks_on_reset_password_token", unique: true
  end
